...
<!-- © @ls90901  |https://github.com/ls90901 -->

<head>
<title><?php $name = str_replace('_', ' ', $_REQUEST["c"]); echo $name; ?> |Lsmeena</title>
...
.loading {
    ...
    .plyr__video-wrapper::after {
        ...
        height: 35px;
        width: 35px;
        background: url('https://ov12-engine.flamingtext.com/netfu/tmp28000/coollogo_com-169671348.png') no-repeat;
        background-size: 35px auto, auto;
    }
